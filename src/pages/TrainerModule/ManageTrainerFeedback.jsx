                                            ...
                                            feedbacks.map((item, index) => (
                                                <tr key={item.id}>
                                                    ...
                                                    <td className="text-center">
                                                        <button className="btn btn-outline-primary btn-sm me-2" onClick={() => navigate(`/trainer/edit-feedback/${item.id}`)}>
...
export default ManageTrainerFeedback;
