...
const ManageTrainerChapters = () => {
    ...
    const { useList } = useCrud({
        entity: "trainerAdmin",
        listUrl: "/trainerAdmin/getChaptersContent",
    });
        ...
        <div className="container-fluid">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <div className="d-flex align-items-center heading-with-icon">
                    ...
                    <div>
                        <h5 className="fw-bold mb-0">Trianer Chapters Management</h5>
                ...
                <div className="row g-2">
                    ...
                    <div className="col-md-3">
                        <SelectFilter
                            ...
                            options={trainerCourses.map((course) => ({
                    ...
                    <div className="col-md-3">
                        <SelectFilter
                            ...
                            options={trainerModules.map((module) => ({
...
export default ManageTrainerChapters;
