                                ...
                                {isLoading ? (
                                    ...
                                    activities.map((activity, i) => (
                                        <tr key={activity.id}>
                                            ...
                                            <td>
                                                <Link to={`/trainer/view-activity/${activity.id}`} className="text-primary text-decoration-underline">
                                                    {activity.photoCount}
                                                </Link>
                                            </td>
                                            <td>
                                            ...
                                            <td className="text-center">
                                                <button className="btn btn-outline-primary btn-sm me-2" onClick={() => navigate(`/trainer/edit-activity/${activity.id}`)}>
                                                    <i className="bi bi-pencil"></i>
                                                </button>
                                                <button className="btn btn-outline-success btn-sm me-2" onClick={() => navigate(`/trainer/view-activity/${activity.id}`)}>
...
export default TrainerManageActivities;
