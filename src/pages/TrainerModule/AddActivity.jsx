    ...
    useEffect(() => {
        if (data && isEditMode) {
            setFormData({
                ...
                centreType: Number(data.trainerType || data.centreType || 0),
                photos: [],
                videos: [],
    ...
    const handleSubmit = (e) => {
        ...
        if (isEditMode) {
            updateMutation.mutate(
                { id, data: payload },
                { onSuccess: () => navigate("/trainer/manage-activities") }
            );
        } else {
    ...
    return (
        <div className="container-fluid">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <Link to="/trainer/manage-activities" className="btn btn-outline-primary">
                    Manage Activities
                </Link>
            </div>
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-4 text-center">
                            <FormActions
                                onCancel={() => navigate("/trainer/manage-activities")}
...
export default TrainerAddActivity;
