...
const ManagePerformanceGradeBulkUpload = () => {
    ...
    const { createMutation } = useCrud({
        entity: "bulkUpload",
        createUrl: "/student/performance/bulkUpload",
    })
    ...
    const handleSubmit = () => {
        ...
        createMutation.mutate(formData, {
            onSuccess: (response) => {
                const data = response;
                toast.success(
                    `Inserted: ${data?.inserted}  | Failed: ${data?.failedCount}`
                );
    ...
    const handleDownloadSample = () => {
        ...
        link.href = "/Performance_grades.csv"; // placed sample file in public folder
        link.download = "Sample_performance_grades.csv";
        link.click();
    };
...
export default ManagePerformanceGradeBulkUpload;