...
const ManageTrainerUpload = () => {
    ...
    const filteredCentres = trainerType ? schoolsData.filter((school) => school.centerType === Number(trainerType)) : schoolsData;
    const { createMutation } = useCrud({
        entity: "bulkUpload",
        createUrl: "/trainer/bulkUpload",
    })
    ...
    const handleDownloadSample = () => {
        ...
        link.href = "/Sample_trainer.csv"; // place sample file in public folder
        link.download = "Sample_trainer.csv";
        link.click();
    };
        ...
        <div className="container-fluid">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                <div className="d-flex align-items-center heading-with-icon">
                    ...
                    <div>
                        <h5 className="fw-bold mb-0">Bulk Upload for Trainers</h5>
                        <p className="text-muted mb-0">
                            Manage all bulk uploads for trainers
                        </p>
                    </div>
                </div>
            </div>
...
export default ManageTrainerUpload;